...
Feature: Test oai-pmh
  ...
  Scenario Outline: get ListRecords with from and until
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: get ListIdentifiers
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: get GetRecord request
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check badArgument in GetRecord request without identifier
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario: check badArgument in GetRecord request with identifier but without metadataPrefix
    ...
    And header x-okapi-token = okapitoken
    And param verb = 'GetRecord'
    And param identifier = 'oai:folio.org:test_oaipmh/54cc0262-76df-4cac-acca-b10e9bc5c79a'
    When method GET
    Then status 400

  Scenario Outline: check badArgument in GetRecord request with invalid identifier
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check badArgument in ListRecords with invalid from
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check badArgument in ListRecords with invalid until
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check badArgument in ListRecords with invalid format date
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check noRecordsMatch in ListRecords request
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: check idDoesNotExist error in GetRecord request
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
  ...
  Scenario Outline: post GetRecord with empty json
    Given url edgeUrl
    And header Accept = 'text/xml'
    And header Content-Type = 'application/json'
    And header x-okapi-token = okapitoken
